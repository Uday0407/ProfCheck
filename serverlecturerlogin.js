...
app.get('/', (req, res) => {
  res.sendFile(__dirname + '/public/signupdemo.html');
});

// Route for signup
app.post('/signuplecturer', async (req, res) => {
  ...
  const mailOptions = {
    ...
    text: 'Click the link to confirm your registration: http://localhost:3036/confirm'
  };
...
// Route for login
app.post('/loginlecturer', async (req, res) => {
  ...
  res.redirect('/lecturerdashboard.html');
});
